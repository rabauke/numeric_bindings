...
int main(int argc, char *argv[]) {
  {
    ...
    }
    {
      ...
      vector x2(x);
      blas::trsv(blas::trans(blas::lower(A_l)), x2);
      std::cout << "testing boost::ublas containers\n"
    ...
    }
    {
      ...
      vector x2(x);
      blas::trsv(blas::trans(blas::upper(A_u)), x2);
      std::cout << "testing boost::ublas containers\n"
    ...
    }
    {
      ...
      vector x2(x);
      blas::trsv(blas::conj(blas::lower(A_l)), x2);
      std::cout << "testing boost::ublas containers\n"
    ...
    }
    {
      ...
      vector x2(x);
      blas::trsv(blas::conj(blas::upper(A_u)), x2);
      std::cout << "testing boost::ublas containers\n"
